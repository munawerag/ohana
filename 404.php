        ...
        <div class="not-found-wrapper">
            <div class="content-wrapper">
                ...
                <div class="not-found-anchor-wrapper">
                    <a href="/" class="btnn btnn--icon">
                        <span class="btnn__text">Go to homepage</span>
                        <span class="btnn__icon">
                            <img src="/assets/svg/btn-arrow.svg" alt="icon" width="22" height="22" class="svg-convert">
                        </span>
                    </a>
                    <a href="javascript:;" class="btnn btnn--icon btnn--icon-outline">
                        <span class="btnn__text">Report a problem</span>
                        <span class="btnn__icon">
                            <img src="/assets/svg/btn-arrow.svg" alt="icon" width="22" height="22" class="svg-convert">
                        </span>
                    </a>
