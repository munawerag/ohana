<section class="getInTouch">
    ...
    <div class="container-s">
        <div class="custom-row justify-content-center">
            <div class="col_12 col_lg_10 text-center">
                <h6 class="text-upper smallHeading animate fadein-Up" data-delay="0.2s">We're Just a Message Away</h6>
                <h3 class="text-upper animate fadein-Up" data-delay="0.3s">Get In Touch</h3>
            </div>
            <div class="col_12 col_lg_10">
                <div class="form-wrapper animate fadein-Up" data-delay="0.4s">
                    ...
                    <input type="hidden" id="captcha-response-letsDiscuss" name="captcha-response-letsDiscuss" class="recaptchaResponse">
